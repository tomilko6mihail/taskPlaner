...
export default createStore({
    state: {
        tasks: [
            ...
            {id: 1, statusId: 0, title: "Мазануть мимо", responsible: "Витя Мамонтов", description: "какой то наипиздатейший текст здесь"},
            {id: 2, statusId: 1, title: "Пройти Miside и жеско отсосать у вонючего бомжа", responsible: "", description: ""},
            {id: 3, statusId: 2, title: "Ошибиться при выборе вуза", responsible: "Впр 11", description: "какой то наипиздатейший текст здесь"}
        ],
        dragOutNative: 1,
        isShowDialog: false,
