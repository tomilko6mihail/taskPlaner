    ...
    tasks: [
      {
        ...
        statusId: 0,
        title: "Вытереть жопу",
        responsible: "Юра Гарифулин",
        description: "какой то наипиздатейший текст здесь",
      },
      {
        id: 1,
        statusId: 0,
        title: "Мазануть мимо",
        responsible: "Витя Мамонтов",
        description: "акой то наипиздатейший текст здесь",
      },
      {
        id: 2,
        statusId: 1,
        title: "Пройти Miside и жеско отсосать у вонючего бомжа",
        responsible: "",
        description: "",
      },
      {
      ...
      },
      {
        id: 4,
        statusId: 2,
        title: "Ашибиться при выборе вуза",
        responsible: "Впр 11",
        description: "rакой то наипиздатейший текст здесь",
      },
    ],
    dragOutNative: 1,
    isShowDialog: false,
